...
describe Student do
  it "can create instances of classes" do
    ...
    instance.class.should eq FirstClass
  end
  ...
  it "can assign and retrieve instance variables" do
    ...
    dog1.get_name.should eq "Fido"
  end

  it "knowns constructor and properties" do
    dog2 = Dog2.new "Fido"
    # accessing instance variables require always a method
    dog2.name.should eq "Fido"
  end

  it "knows class methods" do
    Dog3.kind.should eq "a Dog" # class methods can be called without creating an instance
  end

  it "knows class variables" do
    Dog4.kind.should eq "a Dog" # methods are inherited
    charlie = Dog4.new
    charlie.furColor.should eq "black"
    molly = Dog4.new
    molly.furColor.should eq "brown"
  end
end
